...
export default function Contact() {
  return (
    <div>
      ...
      <p className='mt-12 font-bold text-xl'>Email us Today!</p>
      <div className='text-lg lg:m-8 m-4 md:ml-28 md:mr-28 flex flex-row overflow-auto items-center justify-center flex-wrap'>
{/*card */}
      <div className='m-2 flex flex-col flex-wrap border-4 w-[360px] mt-4 bg-slate-300 border-slate-500 mb-4  rounded-lg shadow-lg shadow-slate-500'>
      <p className='m-3 text-xl font-medium'>OopsScoop Business Email</p>
      <p className='m-3 text-md'>-</p>
      <a href="mailto:oopsScoop@usa.com" target="_blank" rel="noreferrer" className='focus:text-blue-400 mb-8 text-blue-700 hover:text-blue-300 mt-2 font-semibold text-lg'><p>oopsScoop@usa.com</p></a>
</div>
{/*card end */}
...
<br />
      ...
      <div className='text-lg lg:m-8 m-4 md:ml-28 md:mr-28 flex flex-row overflow-auto items-center justify-center flex-wrap'>
{/*card */}
      <div className='m-2 flex flex-col flex-wrap border-4 w-[360px] mt-4 bg-slate-300 border-slate-500 mb-12  rounded-lg shadow-lg shadow-slate-500'>
      <p className='m-3 text-xl font-medium'>Eric Polley</p>
      <p className='m-3 text-md'>OopsScoop Representative</p>
